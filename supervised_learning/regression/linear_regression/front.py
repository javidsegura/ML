...
"""model = back.NormalEquation(path ="/Users/javierdominguezsegura/Programming/Python/Drafts/Scikit/Linear regression/Andrew ng/Multiple linear regression/datasets/my_dataset.csv"
                               ,names = ["Hours", "Salary"], drop="Salary")

print(model.get_all(0.01,50)) # Learning rate is too powerful œ


# Some examples of models are presented here:

# Simple Linear Regression,LSM
model1 = back.LeastSquaredMethod(path = "/Users/javierdominguezsegura/Programming/Python/Drafts/Scikit/Linear regression/Andrew ng/Multiple linear regression/datasets/diabetes_dataset.csv",
